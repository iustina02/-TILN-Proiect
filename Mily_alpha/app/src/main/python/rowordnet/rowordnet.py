...
class RoWordNet(object):
    ...
    def print_synset(self, synset_id: str):
        ...
        if(synset.domain == "gastronomy" or synset.domain == "plants" or synset.domain == "biology" or synset.domain == "chemistry"):
            # print("Synset: "
            #     "\n\t  id={}"
            #     "\n\t  pos={!r}"
            #     "\n\t  nonlexicalized={}"
            ...
            for i in range(len(synset.literals)):
                ...
                list_literals.append(synset.literals[i])
            ...
            #         list_hypernyms.append(out_synset_id)
    ...
    def list_hypernyms(self, synset_id: str):
